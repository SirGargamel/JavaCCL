 ...
 * @author Petr Ječmen
 */
public class MessagePullDaemon extends Observable implements IService, Runnable {
    ...
    public MessagePullDaemon(final DataPacketHandler dpHandler, final ClientManager clientManager) {
        if (dpHandler != null) {
        ...
        comms = clientManager.getClients();
